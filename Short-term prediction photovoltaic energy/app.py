   ...
   # printing latitude and longitude
    ...
    def main():
     if selected_page == "Silicium cristallin":
        ...
        with open(os.path.join('/home/hammal/Bureau/Projet Final ArteFact/models/Silicium_modèle.pkl'), 'rb') as f:
           pickle.load(f)
        ...
        # Use the loaded model to make predictions
         ...
         # Load the model from the file
           ...
           with open(os.path.join('/home/hammal/Bureau/Projet Final ArteFact/models/CIS_modèle.pkl'), 'rb') as f:
            pickle.load(f)
        ...
        with open(os.path.join('/home/hammal/Bureau/Projet Final ArteFact/models/CdTe_modèle.pkl'), 'rb') as f:
            pickle.load(f)
